...
import 'package:lotus_erp/constructors/cadastro_clientes/construtor_municipio.dart';
...
Future<List<Municipio>> getMunicipio() async {
  ...
  var url = Uri.parse('http://$_ip/mobile/municipios?ptipo=2&ptipo_valor=$ibge');
